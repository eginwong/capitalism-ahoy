...
const consoleUI = (function (readline) {
  return {
    ...
    displayAvailableActions: (actions) =>
      console.log(chalk.magenta(`AVAILABLE ACTIONS: `) + chalk.cyan(`${actions.join(", ")}`)),
    ...
    gameOver: (name, netWorth) => console.log(`Game ended. Winner is: 🎉${name}🎉 with a net worth of: ${netWorth}`),
  };
